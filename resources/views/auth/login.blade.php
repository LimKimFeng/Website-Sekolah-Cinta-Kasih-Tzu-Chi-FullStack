...
@section('title', 'Login - Sekolah Cinta Kasih Tzu Chi')
        ...
        <form action="{{ route('login.authenticate') }}" method="POST" class="space-y-6 relative z-10">
            ...
            <div class="space-y-4">
                <div class="relative group">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" class="block w-full pl-11 pr-4 py-3 rounded-xl bg-gray-50 border-2 border-gray-100 text-gray-900 focus:outline-none focus:border-primary focus:bg-white transition-all placeholder-gray-400" placeholder="Email Address" required>
                </div>
                @error('email')
                ...
                <div class="relative group">
                    ...
                    <input type="password" name="password" id="password" class="block w-full pl-11 pr-4 py-3 rounded-xl bg-gray-50 border-2 border-gray-100 text-gray-900 focus:outline-none focus:border-primary focus:bg-white transition-all placeholder-gray-400" placeholder="Password" required>
                </div>
            </div>
            ...
            <p class="text-center text-gray-500 text-sm mt-6">
                Belum punya akun? <a href="{{ route('register') }}" class="text-primary font-bold hover:underline">Daftar disini</a>
            </p>
        </form>
    </div>
</div>
