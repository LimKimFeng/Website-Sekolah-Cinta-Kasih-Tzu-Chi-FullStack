...
<div class="max-w-7xl mx-auto">
        ...
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-center">
            <div class="flex items-center mb-6 md:mb-0">
                ...
                <div>
                    ...
                    <p class="text-green-100 text-lg">Selamat datang di portal PPDB Sekolah Cinta Kasih Tzu Chi.</p>
                </div>
            </div>
            <div class="bg-white/20 backdrop-blur-md px-6 py-3 rounded-2xl border border-white/30">
                <span class="block text-xs text-green-100 uppercase tracking-wider font-bold">Nomor Registrasi</span>
    ...
    <!-- Status Timeline -->
    <div class="mb-12">
        <h2 class="text-2xl font-bold text-gray-800 mb-8">Status Pendaftaran</h2>
        <div class="relative">
            <!-- Connecting Line -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 relative group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2">Lengkapi Biodata</h3>
                    <p class="text-gray-500 text-sm">Isi data diri, orang tua, dan sekolah asal secara lengkap.</p>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 relative group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2">Verifikasi & Pembayaran</h3>
                    <p class="text-gray-500 text-sm">Admin memverifikasi data dan bukti pembayaran Anda.</p>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 relative group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <p class="text-gray-500 text-sm">Hasil seleksi penerimaan peserta didik baru.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-glass border border-gray-100">
            <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center">
                <i class="fas fa-bolt text-accent mr-3"></i> Aksi Diperlukan
            </h3>
            ...
            @if($candidate->status == 'draft')
                <div class="bg-yellow-50 rounded-2xl p-6 border border-yellow-100 mb-6">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h4 class="font-bold text-yellow-800">Biodata Belum Lengkap</h4>
                            <p class="text-yellow-700 text-sm mt-1">Anda belum menyelesaikan pengisian biodata. Silakan lengkapi untuk melanjutkan ke tahap pembayaran.</p>
                        </div>
                    </div>
                </div>
                <a href="{{ route('student.biodata') }}" class="w-full block text-center bg-primary text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    Lengkapi Biodata Sekarang <i class="fas fa-arrow-right ml-2"></i>
                </a>
            @elseif($candidate->status == 'submitted')
                <div class="bg-blue-50 rounded-2xl p-6 border border-blue-100 mb-6">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h4 class="font-bold text-blue-800">Menunggu Verifikasi</h4>
                            <p class="text-blue-700 text-sm mt-1">Data Anda sedang diperiksa. Pastikan Anda sudah mengupload bukti pembayaran.</p>
                        </div>
                    </div>
                </div>
            ...
            @elseif($candidate->status == 'verified')
                <div class="bg-green-50 rounded-2xl p-6 border border-green-100 mb-6">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h4 class="font-bold text-green-800">Pembayaran Terverifikasi</h4>
                            <p class="text-green-700 text-sm mt-1">Terima kasih. Kartu ujian telah dikirim ke email Anda.</p>
                            <div class="mt-4 p-4 bg-white rounded-xl border border-green-200">
                                <p class="text-xs text-gray-500 uppercase font-bold">Jadwal Ujian</p>
            ...
            @elseif($candidate->status == 'accepted')
                <div class="text-center py-8">
                    ...
                    <h2 class="text-3xl font-bold text-primary mb-2">Selamat! Anda Diterima</h2>
                    <p class="text-gray-600">Selamat bergabung di Sekolah Cinta Kasih Tzu Chi.</p>
                </div>
            @endif
        </div>
        ...
        <div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 shadow-glass text-white relative overflow-hidden">
            ...
            <h3 class="text-xl font-bold mb-6 flex items-center relative z-10">
                <i class="fas fa-bullhorn text-accent mr-3"></i> Informasi Penting
            </h3>
            ...
            <ul class="space-y-4 relative z-10">
                <li class="flex items-start bg-white/5 p-4 rounded-xl backdrop-blur-sm border border-white/10">
                    ...
                    <div>
                        <span class="block font-bold text-sm text-gray-300">Batas Akhir Pendaftaran</span>
                ...
                <li class="flex items-start bg-white/5 p-4 rounded-xl backdrop-blur-sm border border-white/10">
                    ...
                    <div>
                        <span class="block font-bold text-sm text-gray-300">Layanan Bantuan</span>
